...
class Classifier {
  ...
  static const String modelFile = "/models/rock_paper_scissors_model.tflite";
  ...
  Future<DetectionClasses> predict(img.Image image) async {
    ...
    for (int y = 0; y < resizedImage.height; y++) {
      for (int x = 0; x < resizedImage.width; x++) {
        ...
        inputBytes[pixelIndex++] = pixel[0] / 127.5 - 1.0;
        inputBytes[pixelIndex++] = pixel[1] / 127.5 - 1.0;
        inputBytes[pixelIndex++] = pixel[2] / 127.5 - 1.0;
      }
    }
